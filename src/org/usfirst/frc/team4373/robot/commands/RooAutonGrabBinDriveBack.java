...
public class RooAutonGrabBinDriveBack extends RooAutonBase {
...
//				oi.rd.putNumber(", value);
		...
		if (hasRaisedArm & !(hasLoweredArm)){
			Robot.rooDrivetrain.setTank(oi.rd.rooGetNumber("Auton Back drive powah: ", 0.4));
			try{
				Thread.sleep((long)oi.rd.rooGetNumber("Auton Back drive delay: ", 4000)); //make this shorter to automove to the inbound station
